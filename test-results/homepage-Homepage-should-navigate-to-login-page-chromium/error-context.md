...
- Name: Homepage >> should navigate to login page
- Location: /Users/stevendiamante/personal/code-ancestry/tests/homepage.spec.ts:38:7
...
Call log:
  - waiting for getByText('Sign Up')
    ...
    at /Users/stevendiamante/personal/code-ancestry/tests/homepage.spec.ts:42:37
```
