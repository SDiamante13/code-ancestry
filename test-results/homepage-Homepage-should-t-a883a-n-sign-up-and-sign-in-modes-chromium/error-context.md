...
- Name: Homepage >> should toggle between sign up and sign in modes
- Location: /Users/stevendiamante/personal/code-ancestry/tests/homepage.spec.ts:54:7
...
Locator: getByText('Join the Evolution')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText('Join the Evolution')

    at /Users/stevendiamante/personal/code-ancestry/tests/homepage.spec.ts:58:56
```
