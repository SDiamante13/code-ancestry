...
- Name: Homepage >> should navigate to refactor creation page
- Location: /Users/stevendiamante/personal/code-ancestry/tests/homepage.spec.ts:15:7
...
Call log:
  ...
  - waiting for locator(':root')
    ...
    at /Users/stevendiamante/personal/code-ancestry/tests/homepage.spec.ts:22:24
```
...
- paragraph: No evolutions yet. Be the first!
- button:
  - img
- img
- heading "Join the Network" [level=3]
- paragraph: Create a free account to share your refactoring stories and learn from the community on CodeAncestry.
- button "Create Free Account"
- button "Continue Browsing"
- paragraph: You can browse all code stories without an account
```
